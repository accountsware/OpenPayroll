...
{
    public abstract class BaseRepository : IDataManager
    {

        protected ObjectContext BaseEntities;
        ...
        protected BaseRepository(ObjectContext baseEntities)
        {
            ConnectionStringProtection(false);
            BaseEntities = baseEntities;
            Connection = baseEntities.Connection as EntityConnection;
